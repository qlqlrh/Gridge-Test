...
public enum BaseResponseStatus {
    ...
    POST_USERS_EMPTY_PASSWORD(false, HttpStatus.BAD_REQUEST.value(), "비밀번호를 입력해주세요."),
    POST_USERS_EMPTY_NAME(false, HttpStatus.BAD_REQUEST.value(), "이름을 입력해주세요."),

    INVALID_SOCIAL_ID(false, HttpStatus.BAD_REQUEST.value(), "소셜 ID가 없습니다."),
    INVALID_JOIN_TYPE(false, HttpStatus.BAD_REQUEST.value(), "유효하지 않은 가입 수단입니다."),
